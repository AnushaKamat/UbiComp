...
public class Model {
    ...
    // Gestures : Flip , W, Figure of 8(Infinity)
    public String[] outputClasses = {"G1FLIP", "G2W", "G3INFINITY"};
    ...
    public Model(Context context) {
        ...
        // Features : Max and Mean of accelerometer data in X, Y, Z directions
        featureNames.put("F1XMax", "numeric");
        featureNames.put("F2YMax", "numeric");
        featureNames.put("F3ZMax", "numeric");
        featureNames.put("F4XMean", "numeric");
        featureNames.put("F5YMean", "numeric");
        featureNames.put("F6ZMean", "numeric");
    }
    ...
    public void train() {
        ...
        try {
            ...
            e.printStackTrace();
            Toast.makeText(context, "Trained" ,Toast.LENGTH_SHORT).show();
            return;
        }
    }
