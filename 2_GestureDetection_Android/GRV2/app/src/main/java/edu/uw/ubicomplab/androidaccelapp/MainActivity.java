...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    private int graphColor[] = {Color.argb(255,244,170,50),
            ...
            Color.argb(225, 30, 200, 170),
            Color.argb(255,240,100,50),
            Color.argb(255, 50, 105, 240),
            Color.argb(225, 220, 220, 100)};
...
//        graph.getGridLabelRenderer().setVerticalLabelsVisible(false);
        ...
        timeAccelX.setTitle("ax");
        graph.addSeries(timeAccelX);
        timeAccelY.setColor(graphColor[1]);
        timeAccelY.setThickness(10);
        timeAccelY.setTitle("ay");
        graph.addSeries(timeAccelY);
        timeAccelZ.setColor(graphColor[2]);
        timeAccelZ.setThickness(10);
        timeAccelZ.setTitle("az");
        graph.addSeries(timeAccelZ);

        graph.addSeries(timeGyroX);
        timeGyroX.setColor(graphColor[3]);
        timeGyroX.setThickness(10);
        timeGyroX.setTitle("gx");
        graph.addSeries(timeGyroY);
        timeGyroY.setColor(graphColor[4]);
        timeGyroY.setThickness(10);
        timeGyroY.setTitle("gy");
        graph.addSeries(timeGyroZ);
        timeGyroZ.setColor(graphColor[5]);
        timeGyroZ.setThickness(10);
        timeGyroZ.setTitle("gz");
