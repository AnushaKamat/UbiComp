...
public class Model {
    ...
    public String[] outputClasses = {"Flip", "\u221e", "W"}; //flip,infinity,W
    ...
    public Model(Context context) {
        ...
        featureNames.put("F1FlipGy", "numeric");
        featureNames.put("F2InfinityAx", "numeric");
        featureNames.put("F3WAy", "numeric");
    }
    ...
    public void addSample(DescriptiveStatistics atime, DescriptiveStatistics ax, DescriptiveStatistics ay, DescriptiveStatistics az,
        ...
        data[0] = gy.getMax() ; //flip
        data[1] = ax.getMax(); //infinity
        data[2] = ay.getMax(); //W
